...
@section('content')
    <div class="card">
        <div class="card-header border-bottom-0">
            <h3 class="card-title mb-0">All Teams (0) </h3>
            <div class="card-actions d-flex gap-1">
                <a href="" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#artistModal">
                    <i class="ti ti-plus me-2"></i> Add Artist
                </a>
                <div class="dropdown action-dropdown">
                    <button type="button" data-bs-toggle="dropdown"
                        class="btn bg-primary-lt dropdown-toggle border-0 shadow-none">
                        <i class="ti ti-dots-vertical"></i>
                    </button>
                    <div class="dropdown-menu">
                        <a href="#" class="dropdown-item status-action-btn" data-target="#bulkActionForm"
                            data-url="{{ route('home') }}"> Mark
                            active </a>
                        <a href="#" class="dropdown-item  status-action-btn" data-target="#bulkActionForm"
                            data-url="{{ route('home') }}">
                            Mark inactive </a>
                        <form id="bulkActionForm" action="" method="POST" class="d-none">
                            @csrf
                        </form>

                        <a class="dropdown-item download-all" data-label="artist" data-bs-target="#downloadArtistForm"
                            href="#">Download all </a>
                        <form id="downloadArtistForm" action="{{ route('home') }}" method="POST" class="d-none">
                            {{ csrf_field() }}
                        </form>
                        <a class="dropdown-item download-selected" data-label="artist" data-bs-target="#downloadArtistForm"
                            href="#">Download selected </a>
                        <form id="deleteSelectedSpecs" action="{{ route('home') }}" method="POST" class="d-none">
                            {{-- @csrf @method('delete') --}}
                        </form>
                        <a class="dropdown-item download-selected text-danger" data-label="option"
                            data-bs-target="#deleteSelectedSpecs" href="#">Delete selected</a>
                    </div>
                </div>
            </div>
        </div>
