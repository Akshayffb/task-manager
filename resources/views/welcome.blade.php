                            ...
                            <div class="col-auto">
                                ...
                                <div class="progress progress-sm">
                                    <div class="progress-bar bg-danger" style="width: 78%" role="progressbar"
                                        aria-valuenow="78" aria-valuemin="0" aria-valuemax="100" aria-label="78% Complete">
                        ...
                        <a href="./illustrations.html">
                            <svg xmlns="http://www.w3.org/2000/svg" height="200" fill="none" viewBox="0 0 800 600">
                                ...
                                <path
                                    ...
                                    fill="#D6D8E2" opacity="0.5" class="tblr-illustrations-good-info-b"></path>
                                <path
                                ...
                                <path
                                    d="M430.113 342.747C431.495 346.504 434.016 349.74 437.324 352.006L437.785 352.333L448.534 352.212L430.113 342.759V342.747Z"
                                    fill="black" opacity="0.1"></path>
                                <path d="M437.797 352.334L452.376 349.28L453.745 353.049L441.263 361.023L437.797 352.334Z"
                                    fill="#DADCE0"></path>
                                <path d="M437.291 352.115L425.063 334.094L419.73 335.997L424.59 355.86L437.291 352.115Z"
                                    fill="#DADCE0"></path>
                                <path d="M437.797 352.334L452.376 349.28L453.745 353.049L441.263 361.023L437.797 352.334Z"
